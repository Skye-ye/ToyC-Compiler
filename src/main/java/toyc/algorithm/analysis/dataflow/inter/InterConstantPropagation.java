package toyc.algorithm.analysis.dataflow.inter;
...
import toyc.algorithm.analysis.graph.icfg.CallEdge;
import toyc.algorithm.analysis.graph.icfg.CallToReturnEdge;
import toyc.algorithm.analysis.graph.icfg.NormalEdge;
import toyc.algorithm.analysis.graph.icfg.ReturnEdge;
...
public class InterConstantPropagation extends
    ...
    public InterConstantPropagation(AlgorithmConfig config) {
        super(config);
